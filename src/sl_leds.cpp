...
#define NUM_STEPS 14            // Количество ступеней в пролёте
#define LEDS_PER_STAIR 2       // Количество диодов на ступеньку
...
// отображение буфера leds на ленту strip
void show() {
    RgbColor pixel;
